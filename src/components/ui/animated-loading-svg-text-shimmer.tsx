...
// ---------------------------------------------------------------------------
// LoadingBreadcrumb — Shimmer text + animated SVG loader
// ---------------------------------------------------------------------------
      ...
      <style>{`
        ...
        .shimmer-text {
          background-image: linear-gradient(
            90deg,
            rgb(113 113 122) 0%, rgb(113 113 122) 40%,
            rgb(24 24 27)    50%,
            rgb(113 113 122) 60%, rgb(113 113 122) 100%
          );
        }
        .dark .shimmer-text {
          background-image: linear-gradient(
            90deg,
            rgb(161 161 170) 0%, rgb(161 161 170) 40%,
            rgb(255 255 255) 50%,
            rgb(161 161 170) 60%, rgb(161 161 170) 100%
          );
        }
      `}</style>

      <div className={cn('flex items-center gap-2 text-[15px] font-medium tracking-wide', className)}>
        ...
        <span
          ...
          style={{ backgroundSize: '200% auto', animation: 'textShimmer 2s ease-in-out infinite' }}
        >
          {text}
        </span>
